...
export const BackgroundBeamsWithCollision = ({ children, className }: { children: React.ReactNode; className?: string }) => {
  ...
  return (
    <div
      ref={parentRef}
      className={cn(
        "bg-gradient-to-b relative flex items-center w-full justify-center overflow-hidden pt-0 bg-custom-black-100",
...
>(({ parentRef, containerRef, beamOptions = {} }, ref) => {
  ...
  React.useImperativeHandle(ref, () => beamRef.current as HTMLDivElement);
